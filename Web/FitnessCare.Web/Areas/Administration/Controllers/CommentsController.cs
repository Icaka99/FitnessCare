...
namespace FitnessCare.Web.Areas.Administration.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Comments.Include(c => c.Parent).Include(c => c.User);
        ...
        public async Task<IActionResult> Create([Bind("ParentId,Content,UserId,UserUsername,IsDeleted,DeletedOn,Id,CreatedOn,ModifiedOn")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParentId,Content,UserId,UserUsername,IsDeleted,DeletedOn,Id,CreatedOn,ModifiedOn")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
